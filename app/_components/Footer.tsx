export default function Footer() {
  return (
    <>
      <div className="bg-[#1F1818]">
        <footer className="footer items-center p-8 text-neutral-content max-w-[1080px] m-auto">
          <aside className="items-center grid-flow-row">
            <span className="text-white text-2xl font-extrabold">GPS TRANSFER</span>
            <p className="text-white">Copyright © 2024 - All right reserved</p>
          </aside>
          <nav className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
            <a href="https://www.instagram.com/gpstransfer/">
              <svg
